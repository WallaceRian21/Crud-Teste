                ...
                <div class="navbar-container container-fluid">
                    ...
                    <ul class="nav-right">
                        <li class="user-profile header-notification">
                            <a href="#!">
                                <!--                                <span>-->
                                <?php //= ucfirst($_SESSION['nome']); ?><!--</span>-->
                                ...
                                <div class="page-body">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <span>Informações da Produto</span>
                                        ...
                                        <form method="POST" action="#">
                                            <div class="card-block">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="descricao" class="form-control" value="" placeholder="Descrição">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="quantidade" class="form-control" value="" placeholder="Quantidade">
                                                    </div>
                                                </div>

                                                <input type="hidden" name="id" value="">
                                                <button type="submit" style="position:relative; margin-left: 200px"
                                                        onclick="return confirm('Você tem certeza que deseja Editar esse Registro ?');"
                                                        class="btn btn-info btn-round">Salvar
                                                </button>
                                        </form>
                                    </div>
                                </div>
